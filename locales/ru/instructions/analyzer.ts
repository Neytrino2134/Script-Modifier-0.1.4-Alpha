...
export const analyzer = {
    ...
    'instruction.desc.shot_filter_wide': 'ПРОТОКОЛ ТРАНСЛЯЦИИ: Если сценарий требует "слезу на щеке", вы ОБЯЗАНЫ перевести это в позу тела на ОБЩЕМ плане (напр. "Плечи опущены, голова низко"). Крупные планы (CU/ECU) СТРОГО ЗАПРЕЩЕНЫ.',
